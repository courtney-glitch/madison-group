...
const defaultBranding: BrandingSettings = {
  brandName: "Madison Group Properties",
  tagline: "Building Beautiful Lives",
  primaryColor: "#B19A55",
  accentColor: "#F8F5EF",
};

export default function BrandingSettingsPage() {
  const [brandName, setBrandName] = useState(defaultBranding.brandName);
  ...
  const [accentColor, setAccentColor] = useState(defaultBranding.accentColor);
  ...
  async function loadSettings() {
    ...
    const savedSettings = data?.setting_value as Partial<BrandingSettings> | null;

    if (savedSettings) {
      setBrandName(savedSettings.brandName || defaultBranding.brandName);
      setTagline(savedSettings.tagline || defaultBranding.tagline);
      setPrimaryColor(savedSettings.primaryColor || defaultBranding.primaryColor);
      setAccentColor(savedSettings.accentColor || defaultBranding.accentColor);
    }
  ...
  async function saveSettings() {
    ...
    const settingValue: BrandingSettings = {
      brandName,
      tagline,
      primaryColor,
      accentColor,
    ...
    setStatus("Branding settings saved successfully.");
    setSaving(false);
  }
